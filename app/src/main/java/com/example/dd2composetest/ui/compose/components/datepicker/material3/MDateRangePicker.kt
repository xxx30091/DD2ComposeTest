 ...
 *
 * @param state state of the date range picker. See [rememberDateRangePickerState2].
...
fun MaterialDateRangePicker(
    ...
    DateEntryContainer(
        ...
        headlineTextStyle = LocalTypography.current.fromToken(
...
@Preview
@Composable
fun PreviewMaterialDateRangePicker() {
    Column(modifier = Modifier.background(Color.White)) {
        MaterialDateRangePicker(
            state = rememberDateRangePickerState2()
        )
    }
}

/**
 * Creates a [DateRangePickerState] for a [MaterialDateRangePicker] that is remembered across compositions.
 *
...
@Composable
@ExperimentalMaterial3Api
fun rememberDateRangePickerState2(
