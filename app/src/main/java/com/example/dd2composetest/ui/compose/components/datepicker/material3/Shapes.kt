...
import com.example.dd2composetest.ui.compose.components.datepicker.material3.token.ShapeKeyTokens
import com.example.dd2composetest.ui.compose.components.datepicker.material3.token.ShapeTokens
...
internal fun ShapeKeyTokens.toShape(): Shape {
    return LocalShapes.current.fromToken(this)
}
//MaterialTheme.shapes.fromToken(this)
