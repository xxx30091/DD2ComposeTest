...
internal class TextFieldSelectionManager(
    val undoManager: FakeUndoManager? = null
) {
        ...
        override fun onStart(startPoint: Offset) {
            ...
            state?.layoutResult?.let { layoutResult ->
                ...
                updateSelection(
                    ...
                    isStartHandle = false,
                    adjustment = FakeSelectionAdjustment.Word
                )
    ...
    internal val mouseSelectionObserver = object : MouseSelectionObserver {
        override fun onExtend(downPosition: Offset): Boolean {
            state?.layoutResult?.let { layoutResult ->
                ...
                updateSelection(
                    ...
                    isStartHandle = false,
                    adjustment = FakeSelectionAdjustment.None
                )
                return true
            }
            return false
        ...
        override fun onDrag(dragPosition: Offset, adjustment: FakeSelectionAdjustment): Boolean {
            if (value.text.isEmpty()) return false
            ...
            override fun onDrag(delta: Offset) {
                ...
                state?.layoutResult?.value?.let { layoutResult ->
                    ...
                    updateSelection(
                        ...
                        adjustment = FakeSelectionAdjustment.Character
                    )
                }
                state?.showFloatingToolbar = false
            }
