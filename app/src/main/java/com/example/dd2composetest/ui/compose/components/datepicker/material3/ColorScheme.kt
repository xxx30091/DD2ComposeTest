...
import androidx.compose.ui.unit.dp
import com.example.dd2composetest.ui.compose.components.datepicker.material3.token.ColorDarkTokens
import com.example.dd2composetest.ui.compose.components.datepicker.material3.token.ColorLightTokens
import com.example.dd2composetest.ui.compose.components.datepicker.material3.token.ColorSchemeKeyTokens
...
fun contentColorFor(backgroundColor: Color) =
    LocalColorScheme.current.contentColorFor(backgroundColor).takeOrElse {
...
internal fun ColorSchemeKeyTokens.toColor(): Color {
    return LocalColorScheme.current.fromToken(this)
}
//MaterialTheme.colorScheme.fromToken(this)