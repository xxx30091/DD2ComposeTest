...
//         */
//        將提供的波斯語 **Shamsi** 日期轉換為儒略日數（即自公元前 4713 年 1 月 1 日以來的天數）。
//        由於波斯日曆是一種高度規則的日曆，因此與儒略日數之間的轉換並不像看起來那麼困難。
//        基本上它是除法、舍入和乘法的數學。 此例程使用儒略日編號 1948321 作為焦點，因為該儒略日編號對應於 1 Farvardin (1) 1。
//
...
//                    (CalendarConstants.PERSIAN_EPOCH - 1L) +
