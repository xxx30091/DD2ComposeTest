 ...
 */
internal interface FakeSelectionAdjustment {
    ...
    companion object {
         ...
         * selection range.
         */
        val None = object : FakeSelectionAdjustment {
            override fun adjust(
                textLayoutResult: TextLayoutResult,
                newRawSelectionRange: TextRange,
                previousHandleOffset: Int,
         ...
         */
        val Character = object : FakeSelectionAdjustment {
            override fun adjust(
                textLayoutResult: TextLayoutResult,
                newRawSelectionRange: TextRange,
                previousHandleOffset: Int,
         ...
         */
        val Word = object : FakeSelectionAdjustment {
            override fun adjust(
                textLayoutResult: TextLayoutResult,
                newRawSelectionRange: TextRange,
                previousHandleOffset: Int,
                ...
                return adjustByBoundary(
                    textLayoutResult = textLayoutResult,
                    newRowSection = newRawSelectionRange,
         ...
         */
        val Paragraph = object : FakeSelectionAdjustment {
            override fun adjust(
                textLayoutResult: TextLayoutResult,
                newRawSelectionRange: TextRange,
                previousHandleOffset: Int,
        ...
        private fun adjustByBoundary(
            ...
            val startBoundary = boundaryFun(newRowSection.start.coerceIn(0, maxOffset))
            val endBoundary = boundaryFun(newRowSection.end.coerceIn(0, maxOffset))
            ...
            val start = if (newRowSection.reversed) startBoundary.end else startBoundary.start
            val end = if (newRowSection.reversed) endBoundary.start else endBoundary.end
         ...
         */
        val CharacterWithWordAccelerate = object : FakeSelectionAdjustment {
            override fun adjust(
                textLayoutResult: TextLayoutResult,
                newRawSelectionRange: TextRange,
                previousHandleOffset: Int,
