...
import com.example.dd2composetest.ui.compose.fakecomponents.Selection.AnchorInfo
import com.example.dd2composetest.utils.test.fastFold
    ...
    fun handleDragObserver(isStartHandle: Boolean): TextDragObserver = object : TextDragObserver {
        ...
        override fun onDrag(delta: Offset) {
            ...
            val consumed = updateSelection(
                ...
                isStartHandle = isStartHandle,
                adjustment = FakeSelectionAdjustment.CharacterWithWordAccelerate
            )
            if (consumed) {
